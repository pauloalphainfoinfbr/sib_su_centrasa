<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="relVeiculosRecuperados.aspx.cs" Inherits="SIB.Relatorios.relVeiculosRecuperados" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cD" runat="server">
    <form id="veiculosRecuperados" runat="server">
        <br />
            <div class="well" style="width:792px">
                <table>
                    <tr>
                        <td colspan="4">
                            <strong><span style="font-size: 11pt; color:green"">Veículos Recuperados</span></strong>
                            <br /><br />
                        </td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        $("#btnFiltrar").click(function (e) {
            ...
            $.ajax({
                url: 'genericReport.aspx/veiculosRecuperados',
