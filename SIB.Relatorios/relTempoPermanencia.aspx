<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="relTempoPermanencia.aspx.cs" Inherits="SIB.Relatorios.relTempoPermanencia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cD" runat="server">
         ...
         <br />
            <div class="well" style="width:792px">
                <table>
                    <tr>
                        <td colspan="4">
                            <strong><span style="font-size: 11pt; color:green"">Tempo de Permanência</span></strong>
                            <br /><br />
                        </td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        $("#btnFiltrar").click(function (e) {
            ...
            $.ajax({
                url: 'genericReport.aspx/tempoPermanencia',
