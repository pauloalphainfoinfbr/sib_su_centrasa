<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="relPesoTotalEscoado.aspx.cs" Inherits="SIB.Relatorios.relPesoTotalEscoado" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cD" runat="server">

    <form id="frmPesoEscoado" runat="server">        
         <br />
            <div class="well" style="width:1120px">
                <table>
                    <tr>
                        <td colspan="4">
                            <strong><span style="font-size: 11pt; color:green">Peso Total Escoado</span></strong>
                            <br /><br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ClientIDMode="Static" ID="ddlCargaSecaGraneleiro" runat="server" CssClass="input-large">                                                                                                                    
                                <asp:ListItem Value="1">Carga Seca</asp:ListItem>
                                <asp:ListItem Value="2">Graneleiro</asp:ListItem>
                                <asp:ListItem Value="0" Selected="True">Todos</asp:ListItem>
                            </asp:DropDownList>
                        </td>                                   
                    </tr>
    ...
    <script type="text/javascript">
        ...
        $("#btnFiltrar").click(function (e) {
            ...
            obj.veiculoDedicado = $("#ddlDedicado").val();
            obj.frotaAgregPart = $("#ddlTipoVinculo").val();
            ...
            obj.cargaSecaGraneleiro = $("#ddlCargaSecaGraneleiro").val();
            obj.dt = $("#txtDT").val();

            obj.formato = $("#ddlFormato").val();

            $.ajax({
                url: 'genericReport.aspx/pesoEscoado',
